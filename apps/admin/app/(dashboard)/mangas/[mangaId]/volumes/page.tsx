			...
			<div className="flex items-center gap-4 mb-4">
				...
				<div className="flex-1">
					<h1 className="text-2xl font-bold tracking-tight">
						{manga ? `Gerenciar Volumes: ${manga.title}` : 'Gerenciar Volumes'}
					</h1>
					<p className="text-muted-foreground text-sm">Organize as edições desta obra.</p>
				</div>
			</div>
					...
					{volumes.map((vol) => (
						...
						>
							...
							<div className="p-4 flex flex-col flex-1 justify-between">
								<div>
									<h3 className="font-bold text-lg">Volume {vol.volumeNumber}</h3>
								...
								<div className="flex items-center gap-2 mt-auto">
									...
									<Link href={`/mangas/${mangaId}/volumes/${vol.id}/edit`}>
										<Button
											variant="outline"
											size="icon"
