			...
			<div className="grid gap-6 lg:grid-cols-[1fr_400px]">
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Selecione todas as páginas de uma vez. A ordem de seleção será a ordem
							de leitura.
						</CardDescription>
					</CardHeader>
					<CardContent className="space-y-6">
						...
						<div className="flex flex-col items-center justify-center border-2 border-dashed border-border rounded-lg p-8 bg-muted/10 hover:bg-muted/20 transition-colors">
							...
							<Label
								...
								className="cursor-pointer bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-6 py-2 rounded-md font-medium inline-flex items-center justify-center"
							>
								Procurar Arquivos
							</Label>
					...
					<Card>
						...
						<CardContent>
							<form id="chapter-form" onSubmit={handleSubmit} className="space-y-4">
								...
								<div className="space-y-2">
									<Label htmlFor="title">Título do Capítulo (Opcional)</Label>
									<Input
										id="title"
